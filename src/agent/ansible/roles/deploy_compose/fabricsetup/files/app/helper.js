...
// 	  client = hfc.loadFromConfig(hfc.getConfigSetting('network'+config));
...
//       logger.debug('User is not enrolled, so we will need an admin user object to register');
// 			var admins = hfc.getConfigSetting('admins');
//       logger.debug('2: username: ' + admins[0].username + '  pass: ' + admins[0].secret);
