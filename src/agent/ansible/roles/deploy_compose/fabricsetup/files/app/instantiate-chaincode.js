...
var instantiateChaincode = async function(channelName, chaincodeName, chaincodeVersion, chaincodeType, functionName, args, username, org_name) {
	...
	try {
		...
		logger.debug('Sending instantiate proposal');
		logger.debug(process.env.GOPATH);
		process.env.GOPATH = "/app/chaincode";
